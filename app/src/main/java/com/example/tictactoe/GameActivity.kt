...
class GameActivity : AppCompatActivity() {
    ...
    private fun getChangedCell() {
        when {
            pollState[0] != "0" -> binding.textView1.text = pollState[0]
            pollState[1] != "0" -> binding.textView2.text = pollState[1]
            pollState[2] != "0" -> binding.textView3.text = pollState[2]
            pollState[3] != "0" -> binding.textView4.text = pollState[3]
            pollState[4] != "0" -> binding.textView5.text = pollState[4]
            pollState[5] != "0" -> binding.textView6.text = pollState[5]
            pollState[6] != "0" -> binding.textView7.text = pollState[6]
            pollState[7] != "0" -> binding.textView8.text = pollState[7]
            pollState[8] != "0" -> binding.textView9.text = pollState[8]
        }
    }
